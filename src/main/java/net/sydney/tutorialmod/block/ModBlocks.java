package net.sydney.tutorialmod.block;

import net.fabricmc.fabric.api.itemgroup.v1.ItemGroupEvents;
import net.sydney.tutorialmod.TutorialMod;

import net.sydney.tutorialmod.block.custom.MagicBlock;
...
public class ModBlocks {
    ...
    public static final Block TOMATO = registerBlockWithoutBlockItem("tomato",
            new Tomato(AbstractBlock.Settings.copy(Blocks.SWEET_BERRY_BUSH).create()
